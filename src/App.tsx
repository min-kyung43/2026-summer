...
const problemStages = [
  {
    ...
    clue: '돌고 돌아 다시 빛이 모이는 곳. 모든 신호가 이어지는 중심.',
    actionText: 'QR 스캔 시작',
  ...
  },
  {
    ...
    title: '침묵의 수신호',
    intro: [
      '기록에는 말 대신 수신호가 남겨져 있다.',
      '손짓들 사이의 관계를 이해해야만 숨겨진 숫자를 읽어낼 수 있다.',
      '물음표에 들어갈 값을 찾아야 기록이 열린다.',
    ],
    story: [
      '기록에는 말 대신 수신호가 남겨져 있다.',
      '손짓들 사이의 관계를 이해해야만',
  ...
  },
  {
    ...
    intro: [
      '암호화된 숫자 배열이 발견되었다.',
      '흰 원은 맞는 숫자의 개수를, 검은 원은 숫자와 위치가 모두 맞음을 의미한다.',
      '모든 단서를 조합하여 완전한 암호를 찾아야 한다.',
    ],
    story: [
      '암호화된 숫자 배열이 발견되었다.',
      '흰 원은 맞는 숫자의 개수를 의미한다.',
  ...
  },
  {
    ...
    intro: [
      ...
      '성경 속 숫자를 모아 암호 코드를 만들고 손상된 말씀을 복구해야 한다.',
  ...
  },
  {
    ...
    intro: [
      '뒤섞인 문자 기록이 발견되었다.',
      '기록은 일부러 순서를 잃은 것처럼 보인다.',
      '올바른 이름을 복구하면 또 하나의 신호가 안정화된다.',
    ],
    story: [
      '뒤섞인 문자 기록이 발견되었다.',
      '기록은 일부러 순서를 잃은 것처럼 보이고',
      '문자의 순서를 바로잡아야만',
      '감추어진 이름을 확인할 수 있다.',
    ],
    questionLabel: '문제',
    ...
    answer: '장성교회',
    clueTitle: '문제를 풀었을 때 얻는 단서',
    clue: '별빛 아래 오래 머문 흔적. 바깥 공기 속에서 희미한 빛이 흔들린다.',
    actionText: 'QR 스캔 시작',
    tip: '현장 QR 신호를 스캔하십시오.',
    hint: '애너그램을 생각해 보시오.',
    state: 'QR 신호 대기',
